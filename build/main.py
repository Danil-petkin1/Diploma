...
def extract_information():
    ...
    headers = ('Auction Types', 'A', 'B', 'C', 'D', 'Winner Type', 'Revenue',
                'Speed')
    ##'Auctioneer Satisfaction', 'Social Welfare', 'Efficiency','Winner Satisfaction'
...
def run_simulation():
    ...
    print("Выполнение заняло {0} секунд.\n Информация сохранена в файл '{1}'.".format(end - start, file_name))
